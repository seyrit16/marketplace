...
public class CardController {
    ...
    public ResponseEntity<CardResponse> getCardById(@RequestParam(name = "id") Long id) {
    ...
    public ResponseEntity<List<CardResponse>> getAllCards() {
        ...
        List<CardResponse> cardResponseList
                = cardList.stream()
                .map(cardMapper::toCardResponse).toList();
    ...
    public ResponseEntity<Void> linkToUser(@RequestBody CardLinkRequest cardLinkRequest) {
    ...
    @DeleteMapping()
    public ResponseEntity<Void> deleteCardById(@RequestParam(name = "id") Long id){
