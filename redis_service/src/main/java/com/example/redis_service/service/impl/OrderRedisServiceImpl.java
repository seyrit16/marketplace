...
@Service
public class OrderRedisServiceImpl<T> extends RedisServiceImpl<Object>{
    @Autowired
    public OrderRedisServiceImpl(RedisTemplate<String, Object> redisTemplate, KafkaTemplate<String, Object> kafkaTemplate) {
        super(redisTemplate, kafkaTemplate);
    }

    @Override
    @KafkaListener(topics = "order-topic-save", groupId = "redis-group")
    ...
    @Override
    @KafkaListener(topics = "order-topic-get", groupId = "redis-group")
    ...
    @Override
    @KafkaListener(topics = "order-topic-exists", groupId = "redis-group")
    ...
    @Override
    @KafkaListener(topics = "order-topic-delete", groupId = "redis-group")
    ...
    @Override
    @KafkaListener(topics = "order-topic-save-to-hash", groupId = "redis-group")
    ...
    @Override
    @KafkaListener(topics = "order-topic-get-from-hash", groupId = "redis-group")
